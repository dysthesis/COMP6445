...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{pcap_timespan.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{virustotal_spotify.png}
